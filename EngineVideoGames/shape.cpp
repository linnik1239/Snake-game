...
Shape::Shape(Bezier1D *curve, unsigned int xResolution, unsigned int yResolution, bool is2D, unsigned int mode, int whichShape)
{
	mesh = new MeshConstructor(curve, is2D, xResolution, yResolution, whichShape);
	this->mode = mode;
	isCopy = false;
	toRender = true;
	texID = -1;
