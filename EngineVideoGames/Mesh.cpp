...
BoundingBox::BoundingBox(void) {
	this->xInit = glm::vec3(1, 0, 0);
	this->yInit = glm::vec3(0, 1, 0);
	this->zInit = glm::vec3(0, 0, 1);
	this->size = glm::vec3(SCALE, SCALE, SCALE);
	//this->size = glm::vec3(3.3f, 3.3f, 3.3f);
...
glm::vec3 BoundingBox::getXint() {
	return this->xInit;
}
glm::vec3 BoundingBox::getYint() {
	return this->yInit;
}
glm::vec3 BoundingBox::getZint() {
	return this->zInit;
}
void BoundingBox::setXint(glm::vec3 xInt) {
	this->xInit = xInt;
}
void BoundingBox::setYint(glm::vec3 yInt) {
	this->yInit = yInt;
}
void BoundingBox::setZint(glm::vec3 zInt) {
	this->zInit = zInt;
}
...
void BoundingBox::moveCenter(glm::vec3 distance) {
...
glm::vec3 BoundingBox::getAxisBox() {
	return zInit;
}
